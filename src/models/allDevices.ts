...
export const allDevices: { [deviceId: string]: DeviceDataKind } = {
  ...
  "321": {
    ...
    textPosition: [WEST_WALL + 272, NORTH_WALL + 410],
    attributes: {},
    label: "",
    name: "",
    clickingBox: {
  ...
  "322": {
    ...
    textPosition: [WEST_WALL + 170, NORTH_WALL + 320],
    attributes: {},
    label: "",
    name: "",
    clickingBox: {
  ...
  "9": {
    ...
    kind: "SWITCH",
    note: "Jacob",
    textPosition: [WEST_WALL + 185, NORTH_WALL + 70],
    attributes: {},
    label: "",
    name: "",
    clickingBox: {
  ...
  "194": {
    ...
    textPosition: [WEST_WALL - 30, NORTH_WALL + 260],
    attributes: {},
    label: "",
    name: "",
    clickingBox: {
  ...
  "2": {
    ...
    textPosition: [WEST_WALL + 250, NORTH_WALL + 280],
    attributes: {},
    label: "",
    name: "",
    clickingBox: {
  ...
  "577": {
    id: "577",
    kind: "DIMMER",
    note: "Master Closet Room Light",
    textPosition: [WEST_WALL + 162, NORTH_WALL + 244],
    attributes: {},
    label: "",
    name: "",
    clickingBox: {
  ...
  "16": {
    ...
    path: [
      [WEST_WALL + 203, NORTH_WALL + 408],
      [WEST_WALL + 140, NORTH_WALL + 408],
      [WEST_WALL + 127, NORTH_WALL + 452],
      [WEST_WALL + 50, NORTH_WALL + 453],
      [WEST_WALL + 150, NORTH_WALL + 530],
      [WEST_WALL + 221, NORTH_WALL + 462],
      [WEST_WALL + 209, NORTH_WALL + 415],
    ],
    attributes: {},
    label: "",
    name: "",
  ...
  "30": {
    ...
    textPosition: [WEST_WALL + 170, NORTH_WALL + 220],
    path: [
      [WEST_WALL + 200, NORTH_WALL + 160],
      [WEST_WALL + 250, NORTH_WALL + 160],
    ],
    attributes: {},
    label: "",
    name: "",
  ...
  "17": {
    ...
    textPosition: [WEST_WALL + 140, NORTH_WALL + 80],
    attributes: {},
    label: "",
    name: "",
  },
  "483": {
    ...
    textPosition: [WEST_WALL + 93, NORTH_WALL + 75],
    attributes: {},
    label: "",
    name: "",
    clickingBox: {
